...
public class DCMedico extends javax.swing.JDialog {
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        if (this.getMedicoSelected() != null) {
            ...
            medicoDao.delete(this.getMedicoSelected().getCodPessoa());
            this.atualizarJTable();
        } else {
            JOptionPane.showMessageDialog(this, "Nenhum Médico selecionado!");
        }
    ...
    private void atualizarJTable() {
        MedicoDao medicoDao = new MedicoDao();
        this.getTbMedico().setModel(medicoDao.getTableModel());
